...
- Microsoft authenticates you and returns a signed OIDC identity token
- The App reads only the domain portion of your verified email to build the proof
- The proof discloses the DOMAIN, not your address, your name, or your directory record
- Microsoft's own handling of the sign-in is governed by their privacy statement:
