#!/usr/bin/env python3
"""Generate Feature Graphic screenshot using Playwright"""
...
<head>
    ...
    <title>ZKProofport Feature Graphic</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .shield {
            ...
            background:
                ...
                linear-gradient(135deg, #7c3aed, #6366f1, #8b5cf6) border-box;
            display: flex;
            align-items: center;
            justify-content: center;
        }
...
<body>
    ...
    <div class="content">
        <div class="text-content">
            <h1 class="app-name">ZKProofport</h1>
            <p class="tagline">Prove without revealing</p>
            <p class="tagline-kr">공개하지 않고 증명하세요</p>
        </div>
    ...
    <div class="noise"></div>
        ...
        await page.screenshot(
            path=os.path.join(os.path.dirname(os.path.abspath(__file__)), 'feature-graphic.png'),
            type='png'
        )

        await browser.close()
        print(f"Screenshot saved: {os.path.join(os.path.dirname(os.path.abspath(__file__)), 'feature-graphic.png')} (1024x500)")
