  ...
  class SummaryWriter
    ...
    def gaps_section
      [
        ...
        '  the private half, so none are in this directory. New keys must be generated on the ',
        '  corporate account regardless, which is why no attempt is made to find the old ones.',
